...
public class PayslipController {
    ...
    public ResponseEntity<String> getAll(@RequestParam String session_id) {
        if (session_id == null || session_id.isEmpty()) {
            return JSONUtil.BAD_REQUEST_ERROR;
        }

        SessionDTO dto = new SessionDTO();
        dto.setSession_id(Integer.parseInt(session_id));
    ...
    public ResponseEntity<String> getAllOfEmployee(@PathVariable("id") Integer id, @RequestParam String session_id) {
        if (session_id == null || session_id.isEmpty()) {
            return JSONUtil.BAD_REQUEST_ERROR;
        }
    ...
    public ResponseEntity<String> get(@PathVariable("id") Integer id, @RequestParam String session_id) {
        if (session_id == null || session_id.isEmpty()) {
            return JSONUtil.BAD_REQUEST_ERROR;
        }
    ...
    public Object getPdf(@PathVariable("id") Integer id, @RequestParam String session_id) {
        if (session_id == null || session_id.isEmpty()) {
            return JSONUtil.BAD_REQUEST_ERROR;
        }
    ...
    public ResponseEntity<String> deletePayslip(@PathVariable("id") Integer id, @RequestParam String session_id) {
        if (session_id == null || session_id.isEmpty()) {
            return JSONUtil.BAD_REQUEST_ERROR;
        }
