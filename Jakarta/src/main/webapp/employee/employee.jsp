<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <body>
        ...
        <form method="post" action="${pageContext.request.contextPath}/form">
            ...
            <hr />
            <label for="matricule">Matricule</label><input name="matricule" id="matricule" type="number"
                placeholder="4444" required min="0">
            <label for="département">Département</label><input name="département" id="département" type="number"
                placeholder="7777" required min="0">
